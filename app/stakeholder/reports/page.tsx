...
import { FileBarChart, Download, Printer, Share2, Eye, Filter } from "lucide-react"
  ...
  return (
    <div className="flex flex-col gap-6 font-sans pb-10 max-w-6xl mx-auto">
      <PageHeader
        ...
        description="Access predefined, read-only reports containing aggregate data about the student registry."
      />
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {[
          "Student Demographic Report",
          "University Distribution Report",
          "Geographical Origin Report",
          "Scholarship Needs Report",
          "Internship Needs Report",
          "Employment Readiness Report"
        ].map(title => (
            ...
            <CardContent className="p-5 flex flex-col gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-muted-foreground mt-0.5">Summary of aggregate registry data.</p>
                </div>
              </div>
              <div className="flex items-center gap-1.5 pt-1 border-t">
                <Button variant="ghost" size="sm" className="flex-1 text-xs h-8" onClick={() => toast.info("Report preview is a premium feature.")}>
